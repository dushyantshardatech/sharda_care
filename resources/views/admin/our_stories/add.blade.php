...
<div id="page-head">
    ...
    <a href="{{url('admin/manageourstories/add')}}" class="add-indent"> Add Story</a>
</div>
		...
		<div class="card-body table-body-new">
		    <div class="table-responsive">
                <div class="indent-form">
                    <form method="post" action="{{ route('addstories') }}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6 col-sm-12">
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        @if($images)
                                            <img src="{{ asset('storage/images/our_stories/' . $images) }}" style="width:60px">
                                        @endif
                                        @error('images')
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-md-4">
                                        <a href="{{url('admin/manageourstories')}}" class="btn btn-block btn-cancel"> Cancel</a>
                                        <button name="add" value="Save" class="button2">Save Story</button>
                                    </div> 
