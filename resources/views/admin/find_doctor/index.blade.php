...
<div id="page-head">
    ...
    <a href="{{url('admin/manageourstories/add')}}" class="add-indent"> Add Doctor</a>
</div>
    ...
    <div class="admin-roles">
        <div class="container-fluid">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Manage Find Doctor</li>
            </ol>
        </div>
        ...
        <div class="admin-container">
            <div class="header-admin">
				<div class="card-header card-header-new ">
				    <h3> <i class="fas fa-fw fa-tachometer-alt"></i> Manage Find Doctor </h3>
