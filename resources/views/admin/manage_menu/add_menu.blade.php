                    ...
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6 col-sm-12">
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <input type="text" name="menu_name" id="menu_name" value="{{$menu_name}}" class="form-control" required />
                                        @error('menu_name')
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-12">
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <input type="text" name="manage_url" id="manage_url" value="{{$manage_url}}" class="form-control" required />
                                        @error('manage_url')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-md-4">
                                        <a href="{{url('admin/managemenu')}}" class="btn btn-block btn-cancel"> Cancel</a>
                                        <button name="add" value="Save" class="button2">Save Menu</button>
                                    </div> 
